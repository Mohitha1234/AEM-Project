package com.task01.core.handler;
...
@Component(immediate = true, service = EventHandler.class, property = {
        ...
        EventConstants.EVENT_FILTER + "=(path=/content/task01/us/work/*)"
})
public class PageEventHandler implements EventHandler {
    ...
    private static final String WORKFLOW_MODEL_PATH = "/var/workflow/models/marvel-page";
    ...
    public void handleEvent(org.osgi.service.event.Event event) {
        ...
        param.put(ResourceResolverFactory.SUBSERVICE, "workflow-test");
